...
function buildPresupuestoHTML(d, modelo, p, ref) {
  ...
  // 5. NO INCLUIDOS — 7 items (licencia de obra eliminada: cubierta por Arquitecto+Perito)
  html += '<div class="section"><div class="section-title">Servicios no incluidos</div><ul class="no-incl"><li>Cimentaci&oacute;n y movimiento de tierras</li><li>Acometida el&eacute;ctrica a red general</li><li>Acometida de agua y saneamiento</li><li>Mobiliario y electrodom&eacute;sticos</li><li>Vallado y urbanizaci&oacute;n de parcela</li><li>Jardiner&iacute;a y paisajismo</li><li>Modificaciones posteriores a la firma</li></ul></div>';
  html += secTerreno;
  // 6. PAGOS
